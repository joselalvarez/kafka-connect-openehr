...
@NoArgsConstructor
@AllArgsConstructor
public class RmTypeAlias {

    private String type;
    private String alias;
    private boolean structureAlias;
    ...
    static {
        type2alias = values.stream().collect(Collectors.toMap(RmTypeAlias::getType, RmTypeAlias::getAlias));
        alias2type = values.stream().collect(Collectors.toMap(RmTypeAlias::getAlias, RmTypeAlias::getType));
    }
