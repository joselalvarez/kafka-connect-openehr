...
import static org.ehrbase.openehr.sdk.dbformat.DbToRmFormat.TYPE_ATTRIBUTE;
...
public class RmAttributeAlias {
    ...
    static {
        attribute2alias =
                VALUES.stream().collect(Collectors.toMap(RmAttributeAlias::getAttribute, RmAttributeAlias::getAlias));
        alias2attribute =
                VALUES.stream().collect(Collectors.toMap(RmAttributeAlias::getAlias, RmAttributeAlias::getAttribute));
    }
